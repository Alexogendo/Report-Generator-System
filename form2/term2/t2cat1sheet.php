...
<head>
	...
	<title>f2 term2 cat1 marksheet</title>
</head>
<body>
	<div id="links">
	...
	<div id="top">
		...
		<h2><strong>FORM 2 TERM 2 CAT 1 MARKSHEET</strong></h2>
			</div>
	
	<div id="formel">
		<form action="t2cat1sheet.php" method="POST">
	<center>
			<table>
			<tr>
				<th>Adm No</th>
	...
	<?php
        ...
        $fetch_query = "select * from form2_t2_cat1 order by avg DESC";
