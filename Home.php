...
<html>
	...
	<div id="thehead">
		...
		<a class="jj" href="Login.php">Logout</a>
		</div>
			<div class="sname">
		...
		<div class="hme">
		<ul>
			<li><a class="kk" href="Details.php">Register Student</a></li>
			<li><a class="ll" href="Exams.php">Mark Sheets</a></li>
			<li><a class="mm" href="#">School Academic Records</a></li>
			<li><a class="nn" href="ClassReports.php">Print School Reports</a></li>
			<li><a class="oo" href="Record.php">Students Record</a></li>
