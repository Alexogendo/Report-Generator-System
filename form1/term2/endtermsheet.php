...
<head>
	...
	<title>f1 endterm2 marksheet</title>
</head>
<body>
	<div id="links">
	...
	<div id="top">
		...
		<h2><strong>FORM 1 ENDTERM 2 MARKSHEET</strong></h2>
			</div>
	
	<div id="formel">
		<form action="endtermsheet.php" method="POST">
	<center>
			<table>
			<tr>
				<th>Adm No</th>
	...
	<?php
        ...
        $fetch_query = "select * from form1_t2_endterm order by avg DESC";
