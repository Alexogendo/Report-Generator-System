...
if(isset($_POST['view'])){
	...
	echo "<script>window.open('t3cat2sheet.php','_self');</script>";
}
...
<?php 
		...
		$insert_query="insert form4_t3_cat2 (admno,sfn,strm,subj1,subj2,subj3,subj4,subj5,subj6,subj7,subj8,subj9,subj10,
