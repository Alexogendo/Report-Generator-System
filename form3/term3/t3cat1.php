...
<body>
	...
	<?php
		...
		$search_query ="select * from form_three where adm_no = $searchedadmno ";
	...
	<center>
<input type="Submit" name="view" value=" Marksheet Menu"/>

<?php
if(isset($_POST['view'])){

	echo "<script>window.open('t3cat1sheet.php','_self');</script>";
}
...
<?php 
		...
		$insert_query="insert form3_t3_cat1 (admno,sfn,strm,subj1,subj2,subj3,subj4,subj5,subj6,subj7,subj8,subj9,subj10,
