...
<body>
	...
	<div id="top">
		...
		<h2><strong>FORM 3 TERM 2 CAT 2 EXAMS</strong></h2>
...
if(isset($_POST['view'])){
	...
	echo "<script>window.open('t2cat2shaeet.php','_self');</script>";
}
...
<?php 
		...
		if($avg>=0 && $avg<=24){
			...
			$mg='A';
				...
				$insert_query="insert form3_t2_cat2 (admno,sfn,strm,subj1,subj2,subj3,subj4,subj5,subj6,subj7,subj8,subj9,subj10,
