...
<body>
	...
	<div id="top">
		...
		<h2><strong>FORM 3 ENDTERM 2 EXAMS</strong></h2>
	...
	<?php
		...
		$search_query ="select * from studentdetails where adm = $searchedadmno ";
...
<?php 
		...
		if($avg>=0 && $avg<=24){
			...
			$mg='A';
				...
				$insert_query="insert form4_t2_endterm (admno,sfn,strm,subj1,subj2,subj3,subj4,subj5,subj6,subj7,subj8,subj9,subj10,
