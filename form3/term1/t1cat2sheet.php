...
<head>
	...
	<title>f3 term1 cat2 marksheet</title>
</head>
<body>
	<div id="links">
	...
	<div id="top">
		...
		<h2><strong>FORM 3 TERM 1 CAT 2 MARKSHEET</strong></h2>
			</div>
	
	<div id="formel">
		<form action="t1cat2sheet.php" method="POST">
	<center>
			<table>
			<tr>
				<th>Adm No</th>
	...
	<?php
        ...
        $fetch_query = "select * from form3_t1_cat2 order by avg DESC";
