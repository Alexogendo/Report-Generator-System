...
if(isset($_POST['view'])){
	...
	echo "<script>window.open('t1cat2sheet.php','_self');</script>";
}
...
<?php 
		...
		if($avg>=0 && $avg<=24){
			...
			$mg='A';
				...
				$insert_query="insert form3_t1_cat2 (admno,sfn,strm,subj1,subj2,subj3,subj4,subj5,subj6,subj7,subj8,subj9,subj10,
